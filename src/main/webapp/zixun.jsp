...
<head>
    ...
    <style>
        * {
        ...
        .btn_group {
            border: 5px solid rgb(191, 184, 199);
            width: 500px;
            display: flex;
            flex-flow: row;
        ...
        .btn {
            border: #fff;
            background-color: rgba(232, 198, 198, 0.211);
            font-size: larger;
            width: 23%;
            height: 45px;
            padding: 0;
        ...
        .btn:hover {
            background-color: rgb(179, 128, 80);
        }
    ...
    <style>
        ...
        span.dividing {
            width: 20px;
            height: 12px;
            background: url(./image/icon/dividing.gif) no-repeat 50%;
            vertical-align: -1px;
        }
...
<%--    <div class="selfdefine2">--%>
        <div id="nav">
            <ul class="navList fl">
                <li class="fl otherList list"><a href="./homepage.html" class="listA">首页</a></li>
                <li class="fl otherList list"><a href="/brand-demo/selectAllZiXunServlet" class="listA">资讯</a></li>
                <li class="fl otherList list"><a href="/brand-demo/selectAllKeJiServlet" class="listA">科技</a></li>
                <li class="fl otherList list"><a href="./index.html" class="listA">商城</a></li>
            </ul>
            <input type="text" class="nav_input">
            <button class="nav_input">搜索</button>
            <a class="glyphicon glyphicon-user" id="head" href="login.jsp"></a>
